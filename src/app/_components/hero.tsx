...
export default function Hero() {
  ...
  return (
    <div className="bg-white">
      <header className="absolute inset-x-0 top-0 z-50">
        ...
        >
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 max-w-24 p-1.5 sm:max-w-28">
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            ...
            >
              <img
                ...
                src="https://img.buymeacoffee.com/button-api/?text=Buy me a coffee&emoji=&slug=montsesanz&button_colour=FFDD00&font_colour=000000&font_family=Poppins&outline_colour=000000&coffee_colour=ffffff"
              />
            </a>
          </div>
        </nav>
        ...
        >
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              <a href="#" className="-m-1.5 max-w-24 p-1.5">
      ...
      <div className="relative isolate px-6 pt-14 sm:pt-2 lg:px-8">
        <div
          aria-hidden="true"
